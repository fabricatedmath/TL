...
import Crypto.TL.Primitives (Hash(..), flipEndian, hashOnce)
...
hashAbcGroundTruthIter1 = flipEndian $ Hash hash
...
hashAbcGroundTruthIter2 = flipEndian $ Hash hash
