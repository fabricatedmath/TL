...
void sha256_iter(const int numIter, uint32_t* const data) {
    ...
    const __m128i PADDING_SAVE1 = _mm_loadu_si128((const __m128i*) (padding+4));
    const __m128i PADDING_ADD_SAVE1 = _mm_add_epi32(PADDING_SAVE1, _mm_set_epi64x(0xC19BF1749BDC06A7ULL, 0x80DEB1FE72BE5D74ULL));
